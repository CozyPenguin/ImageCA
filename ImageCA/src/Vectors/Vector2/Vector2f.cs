namespace ImageCA.Vectors
{
    ...
    public struct Vector2f : IVector2
    {
        ...
        /// <param name="a">the first value</param>
        /// <param name="b">the second value</param>
        public Vector2f(short a, short b)
        {
            this.a = a;
            this.b = b;
        }
        ...
        public static Vector2f Average(Vector2f a, Vector2f b)
        {
        ...
        /// <returns>returns the arithmetic mean of the vectors</returns>
        public static Vector2f Average(Vector2f a, Vector2f b, Vector2f c)
        {
        ...
        /// <returns>returns the arithmetic mean of the vectors</returns>
        public static Vector2f Average(Vector2f a, Vector2f b, Vector2f c, Vector2f d)
        {
        ...
        public Vector3f ToVector4Beginning(float c)
        {
        ...
        public Vector3f ToVector4End(float a)
        {
