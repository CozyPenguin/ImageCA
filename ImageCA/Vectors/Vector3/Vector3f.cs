...
{
    /// <summary>
    /// A vector containing 3 float values
    /// </summary>
    [System.Serializable]
    public struct Vector3f : IVector3
    {
        /// <summary>
        /// the first value
        /// </summary>
        ...
        /// <param name="b">the second value</param>
        /// <param name="c">the third value</param>
        public Vector3f(int a, int b, int c)
        {
            this.a = a;
            this.b = b;
            this.c = c;
        ...
        /// <param name="b">the second value</param>
        /// <param name="c">the third value</param>
        public Vector3f(byte a, byte b, byte c)
        {
            this.a = a;
            this.b = b;
            this.c = c;
        ...
        /// <param name="b">the second value</param>
        /// <param name="c">the third value</param>
        public Vector3f(short a, short b, short c)
        {
            this.a = a;
            this.b = b;
            this.c = c;
        ...
        /// <returns>returns the arithmetic mean of the vectors</returns>
        public static Vector3f Average(Vector3f a, Vector3f b, Vector3f c)
        {
        ...
        /// <returns>returns the arithmetic mean of the vectors</returns>
        public static Vector3f Average(Vector3f a, Vector3f b, Vector3f c, Vector3f d)
        {
